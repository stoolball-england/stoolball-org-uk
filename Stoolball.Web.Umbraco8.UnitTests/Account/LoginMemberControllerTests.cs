...
namespace Stoolball.Web.UnitTests.Account
{
    public class LoginMemberControllerTests : UmbracoBaseTest
    {
        ...
        {
            using (var controller = new LoginMemberController(Mock.Of<IGlobalSettings>(),
        ...
        public void Post_sets_name_and_description_from_content()
        {
                            ...
                            UmbracoHelper))
            {
                ...
                var result = controller.LoginMember(new ContentModel(currentPage.Object));
        ...
        {
            var method = typeof(LoginMemberController).GetMethod(nameof(LoginMemberController.LoginMember));
        ...
        [Fact]
        public void Post_returns_LoginMember_ModelsBuilder_model()
        {
            using (var controller = new LoginMemberController(Mock.Of<IGlobalSettings>(),
                            Mock.Of<IUmbracoContextAccessor>(),
                            ServiceContext,
