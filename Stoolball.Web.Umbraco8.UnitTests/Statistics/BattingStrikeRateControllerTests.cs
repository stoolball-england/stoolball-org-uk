...
namespace Stoolball.Web.UnitTests.Statistics
{
    ...
    {
        internal static readonly Uri _requestUrl = new Uri("https://example.org" + Constants.Pages.StatisticsUrl + "/batting-strike-rate?querystring=example");
        ...
        public async Task No_results_returns_StatisticsViewModel()
        {
            ...
            statisticsDataSource.Setup(x => x.ReadBestBattingStrikeRate(appliedFilter)).Returns(Task.FromResult(results as IEnumerable<StatisticsResult<BestStatistic>>));
