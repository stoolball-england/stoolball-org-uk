...
namespace Stoolball.Web.UnitTests.Statistics
{
    ...
    {
        internal static readonly Uri _requestUrl = new Uri("https://example.org" + Constants.Pages.StatisticsUrl + "/most-catches?querystring=example");
        ...
        public async Task No_results_returns_StatisticsViewModel()
        {
            ...
            statisticsDataSource.Setup(x => x.ReadMostCatches(appliedFilter)).Returns(Task.FromResult(results as IEnumerable<StatisticsResult<BestStatistic>>));
