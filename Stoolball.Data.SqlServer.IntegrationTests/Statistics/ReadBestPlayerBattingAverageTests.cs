...
namespace Stoolball.Data.SqlServer.IntegrationTests.Statistics
{
    ...
    public class ReadBestPlayerBattingAverageTests
    {
        ...
        [Fact]
        public async Task Read_total_players_with_batting_average_supports_filter_by_team_route()
        {
            var filter = new StatisticsFilter { Team = _databaseFixture.TestData.TeamWithFullDetails };
        ...
        [Fact]
        public async Task Read_best_batting_average_supports_statistics_filtered_by_team_route()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        private async Task ActAndAssertStatistics(StatisticsFilter filter, SqlServerBestPlayerAverageStatisticsDataSource dataSource, Func<Stoolball.Matches.Match, bool> matchFilter, Func<MatchInnings, bool> bowlingInningsFilter, Func<MatchInnings, bool> battingInningsFilter, Func<MatchAward, bool> awardsFilter)
        {
            ...
            foreach (var player in expected)
            {
                ...
                if (player.Average.HasValue)
                {
                    ...
                    Assert.Equal(player.Average.Value.AccurateToTwoDecimalPlaces(), result.Result?.Average?.AccurateToTwoDecimalPlaces());
                }
                else
                {
        ...
        [Fact]
        public async Task Read_best_batting_average_supports_filter_by_team_route()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        public async Task Read_best_batting_average_sorts_by_highest_average_first()
        {
            ...
            decimal? previousAverage = decimal.MaxValue;
