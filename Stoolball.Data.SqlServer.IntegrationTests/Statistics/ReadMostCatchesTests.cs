...
namespace Stoolball.Data.SqlServer.IntegrationTests.Statistics
{
    ...
    public class ReadMostCatchesTests : IDisposable
    {
        ...
        {
            await ForceFifthAndSixthMostCatchesToBeTheSame().ConfigureAwait(false);
        ...
        /// <summary>
        /// Finds the players with the 5th and 6th highest total catches in the shared test data, then updates the
