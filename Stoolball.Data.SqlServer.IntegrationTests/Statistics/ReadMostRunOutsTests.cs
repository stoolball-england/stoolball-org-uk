...
namespace Stoolball.Data.SqlServer.IntegrationTests.Statistics
{
    ...
    public class ReadMostRunOutsTests
    {
        ...
        public ReadMostRunOutsTests(SqlServerTestDataFixture databaseFixture)
        {
            _databaseFixture = databaseFixture ?? throw new ArgumentNullException(nameof(databaseFixture));
        }

        [Fact]
        public async Task Read_total_players_with_runouts_supports_no_filter()
        {
            ...
            var result = await dataSource.ReadTotalPlayersWithRunOuts(null).ConfigureAwait(false);
        ...
        [Fact]
        public async Task Read_total_players_with_runouts_supports_filter_by_club_id()
        {
        ...
        [Fact]
        public async Task Read_total_players_with_runouts_supports_filter_by_team_id()
        {
        ...
        [Fact]
        public async Task Read_total_players_with_runouts_supports_filter_by_team_route()
        {
            var filter = new StatisticsFilter { Team = _databaseFixture.TestData.TeamWithFullDetails };
        ...
        [Fact]
        public async Task Read_total_players_with_runouts_supports_filter_by_match_location_id()
        {
        ...
        [Fact]
        public async Task Read_total_players_with_runouts_supports_filter_by_competition_id()
        {
        ...
        [Fact]
        public async Task Read_total_players_with_runouts_supports_filter_by_season_id()
        {
        ...
        [Fact]
        public async Task Read_most_runouts_returns_player()
        {
        ...
        [Fact]
        public async Task Read_most_runouts_returns_teams()
        {
            var filter = new StatisticsFilter { Paging = new Paging { PageSize = int.MaxValue } };
            _queryBuilder.Setup(x => x.BuildWhereClause(It.IsAny<StatisticsFilter>())).Returns((string.Empty, new Dictionary<string, object>()));
            _playerDataSource.Setup(x => x.ReadPlayers(It.IsAny<PlayerFilter>())).Returns(Task.FromResult(_databaseFixture.TestData.Players));
        ...
        [Fact]
        public async Task Read_most_runouts_returns_statistics()
        {
            var filter = new StatisticsFilter { Paging = new Paging { PageSize = int.MaxValue } };
            _queryBuilder.Setup(x => x.BuildWhereClause(It.IsAny<StatisticsFilter>())).Returns((string.Empty, new Dictionary<string, object>()));
            _playerDataSource.Setup(x => x.ReadPlayers(It.IsAny<PlayerFilter>())).Returns(Task.FromResult(_databaseFixture.TestData.Players));
        ...
        [Fact]
        public async Task Read_most_runouts_supports_statistics_filtered_by_club_id()
        {
        ...
        [Fact]
        public async Task Read_most_runouts_supports_statistics_filtered_by_team_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_most_runouts_supports_statistics_filtered_by_team_route()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_most_runouts_supports_statistics_filtered_by_match_location_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_most_runouts_supports_statistics_filtered_by_competition_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_most_runouts_supports_statistics_filtered_by_season_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        private async Task ActAndAssertStatistics(StatisticsFilter filter, SqlServerBestPlayerTotalStatisticsDataSource dataSource, Func<Stoolball.Matches.Match, bool> matchFilter, Func<MatchInnings, bool> bowlingInningsFilter, Func<MatchInnings, bool> battingInningsFilter)
        {
            ...
            var expected = _databaseFixture.TestData.Players.Select(p => new BestStatistic
            {
                ...
                Total = (int)_databaseFixture.TestData.Matches
                            ...
                            .Where(pi => pi.DismissalType == DismissalType.RunOut && pi.DismissedBy?.Player?.PlayerId == p.PlayerId)
                            .Count(),
            }).Where(x => x.Total > 0);
        ...
        [Fact]
        public async Task Read_most_runouts_supports_no_filter()
        {
            _queryBuilder.Setup(x => x.BuildWhereClause(It.IsAny<StatisticsFilter>())).Returns((string.Empty, new Dictionary<string, object>()));
            _playerDataSource.Setup(x => x.ReadPlayers(It.IsAny<PlayerFilter>())).Returns(Task.FromResult(_databaseFixture.TestData.Players));
            var dataSource = new SqlServerBestPlayerTotalStatisticsDataSource(_databaseFixture.ConnectionFactory, _queryBuilder.Object, _playerDataSource.Object);

            var results = await dataSource.ReadMostRunOuts(null).ConfigureAwait(false);
        ...
        [Fact]
        public async Task Read_most_runouts_supports_filter_by_club_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_most_runouts_supports_filter_by_team_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_most_runouts_supports_filter_by_team_route()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_most_runouts_supports_filter_by_match_location_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
            ...
            var results = await dataSource.ReadMostRunOuts(It.IsAny<StatisticsFilter>()).ConfigureAwait(false);
        ...
        [Fact]
        public async Task Read_most_runouts_supports_filter_by_competition_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_most_runouts_supports_filter_by_season_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_most_runouts_supports_filter_by_date()
        {
            var dateRangeGenerator = new DateRangeGenerator();
            var (fromDate, untilDate) = dateRangeGenerator.SelectDateRangeToTest(_databaseFixture.TestData.Matches);
        ...
        [Fact]
        public async Task Read_most_runouts_sorts_by_highest_total_first()
        {
            var filter = new StatisticsFilter { Paging = new Paging { PageSize = int.MaxValue } };
            _queryBuilder.Setup(x => x.BuildWhereClause(It.IsAny<StatisticsFilter>())).Returns((string.Empty, new Dictionary<string, object>()));
            _playerDataSource.Setup(x => x.ReadPlayers(It.IsAny<PlayerFilter>())).Returns(Task.FromResult(_databaseFixture.TestData.Players));
        ...
        [Fact]
        public async Task Read_most_runouts_pages_results()
        {
        ...
        [Fact]
        public async Task Read_most_runouts_returns_results_equal_to_max_with_max_results_filter()
        {
            ...
            var results = (await dataSource.ReadMostRunOuts(filter).ConfigureAwait(false)).ToList();
