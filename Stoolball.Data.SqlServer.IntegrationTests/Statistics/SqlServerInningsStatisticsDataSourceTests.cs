...
namespace Stoolball.Data.SqlServer.IntegrationTests.Statistics
{
    ...
    public class SqlServerInningsStatisticsDataSourceTests
    {
        ...
        public async Task Read_innings_statistics_supports_no_filter()
        {
            ...
            var expectedAverageRuns = ((decimal)innings.Where(x => x.Runs.HasValue).Average(x => x.Runs!.Value)).AccurateToTwoDecimalPlaces();
            ...
            var expectedAverageWickets = ((decimal)innings.Where(x => x.Wickets.HasValue).Average(x => x.Wickets!.Value)).AccurateToTwoDecimalPlaces();
            ...
            Assert.Equal(expectedAverageRuns, result.AverageRunsConceded?.AccurateToTwoDecimalPlaces());
            Assert.Equal(expectedHighestRuns, result.HighestRunsConceded);
            Assert.Equal(expectedLowestRuns, result.LowestRunsConceded);
            Assert.Equal(expectedAverageWickets, result.AverageWicketsTaken?.AccurateToTwoDecimalPlaces());
        }
        ...
        public async Task Read_innings_statistics_supports_filter_by_club()
        {
            ...
            var expectedAverageRuns = ((decimal)inningsForClub.Where(x => x.Runs.HasValue).Average(x => x.Runs!.Value)).AccurateToTwoDecimalPlaces();
            ...
            var expectedAverageWickets = ((decimal)inningsForClub.Where(x => x.Wickets.HasValue).Average(x => x.Wickets!.Value)).AccurateToTwoDecimalPlaces();
            ...
            var expectedOppositionAverageRuns = ((decimal)inningsForOpposition.Where(x => x.Runs.HasValue).Average(x => x.Runs!.Value)).AccurateToTwoDecimalPlaces();
            var expectedOppositionHighestRuns = inningsForOpposition.Where(x => x.Runs.HasValue).Max(x => x.Runs);
            var expectedOppositionLowestRuns = inningsForOpposition.Where(x => x.Runs.HasValue).Min(x => x.Runs);
            var expectedOppositionAverageWickets = ((decimal)inningsForOpposition.Where(x => x.Wickets.HasValue).Average(x => x.Wickets!.Value)).AccurateToTwoDecimalPlaces();
        ...
        public async Task Read_innings_statistics_supports_filter_by_date()
        {
            ...
            var expectedAverageRuns = ((decimal)inningsMatchingFilter.Where(x => x.Runs.HasValue).Average(x => x.Runs!.Value)).AccurateToTwoDecimalPlaces();
            ...
            var expectedAverageWickets = ((decimal)inningsMatchingFilter.Where(x => x.Wickets.HasValue).Average(x => x.Wickets!.Value)).AccurateToTwoDecimalPlaces();
