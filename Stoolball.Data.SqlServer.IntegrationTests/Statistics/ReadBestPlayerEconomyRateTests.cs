...
namespace Stoolball.Data.SqlServer.IntegrationTests.Statistics
{
    ...
    public class ReadBestPlayerEconomyRateTests
    {
        ...
        public ReadBestPlayerEconomyRateTests(SqlServerTestDataFixture databaseFixture)
        {
        ...
        [Fact]
        public async Task Read_total_players_with_bowling_economy_supports_minimum_qualifying_innings()
        {
        ...
        [Fact]
        public async Task Read_total_players_with_bowling_economy_supports_filter_by_club_id()
        {
        ...
        [Fact]
        public async Task Read_total_players_with_bowling_economy_supports_filter_by_team_id()
        {
        ...
        [Fact]
        public async Task Read_total_players_with_bowling_economy_supports_filter_by_team_route()
        {
            var filter = new StatisticsFilter { Team = _databaseFixture.TestData.TeamWithFullDetails };
        ...
        [Fact]
        public async Task Read_total_players_with_bowling_economy_supports_filter_by_match_location_id()
        {
        ...
        [Fact]
        public async Task Read_total_players_with_bowling_economy_supports_filter_by_competition_id()
        {
        ...
        [Fact]
        public async Task Read_total_players_with_bowling_economy_supports_filter_by_date()
        {
        ...
        [Fact]
        public async Task Read_best_bowling_economy_returns_player()
        {
            ...
            var expected = _databaseFixture.TestData.Players.Where(x => _databaseFixture.TestData.Matches
                                                                            ...
                                                                            .Any(pi => pi.Overs > 0 && pi.RunsConceded.HasValue));
        ...
        [Fact]
        public async Task Read_best_bowling_economy_returns_teams()
        {
            var filter = new StatisticsFilter { Paging = new Paging { PageSize = int.MaxValue } };
            _queryBuilder.Setup(x => x.BuildWhereClause(It.IsAny<StatisticsFilter>())).Returns((string.Empty, new Dictionary<string, object>()));
            _playerDataSource.Setup(x => x.ReadPlayers(It.IsAny<PlayerFilter>())).Returns(Task.FromResult(_databaseFixture.TestData.Players));
        ...
        [Fact]
        public async Task Read_best_bowling_economy_returns_statistics()
        {
            var filter = new StatisticsFilter { Paging = new Paging { PageSize = int.MaxValue } };
            _queryBuilder.Setup(x => x.BuildWhereClause(It.IsAny<StatisticsFilter>())).Returns((string.Empty, new Dictionary<string, object>()));
            _playerDataSource.Setup(x => x.ReadPlayers(It.IsAny<PlayerFilter>())).Returns(Task.FromResult(_databaseFixture.TestData.Players));
        ...
        [Fact]
        public async Task Read_best_bowling_economy_supports_statistics_filtered_by_club_id()
        {
        ...
        [Fact]
        public async Task Read_best_bowling_economy_supports_statistics_filtered_by_team_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_best_bowling_economy_supports_statistics_filtered_by_team_route()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_best_bowling_economy_supports_statistics_filtered_by_match_location_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_best_bowling_economy_supports_statistics_filtered_by_competition_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_best_bowling_economy_supports_statistics_filtered_by_season_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_best_bowling_economy_supports_statistics_filtered_by_date()
        {
            var dateRangeGenerator = new DateRangeGenerator();
            var (fromDate, untilDate) = dateRangeGenerator.SelectDateRangeToTest(_databaseFixture.TestData.Matches);
            ...
            var expected = _databaseFixture.TestData.Players.Select(p => new BestStatistic
            {
                ...
                Average = (_databaseFixture.TestData.Matches
                            ...
                            .Any(bf => bf.Bowler?.Player?.PlayerId == p.PlayerId && bf.Overs > 0 && bf.RunsConceded.HasValue) ?
                                ...
                                .Where(bowlingInningsFilter)
                                .SelectMany(mi => mi.BowlingFigures)
                                .Where(bf => bf.Bowler?.Player?.PlayerId == p.PlayerId && bf.RunsConceded.HasValue && bf.Overs.HasValue)
        ...
        [Fact]
        public async Task Read_best_bowling_economy_supports_minimum_qualifying_innings()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_best_bowling_economy_supports_no_filter()
        {
            _queryBuilder.Setup(x => x.BuildWhereClause(It.IsAny<StatisticsFilter>())).Returns((string.Empty, new Dictionary<string, object>()));
            _playerDataSource.Setup(x => x.ReadPlayers(It.IsAny<PlayerFilter>())).Returns(Task.FromResult(_databaseFixture.TestData.Players));
            var dataSource = new SqlServerBestPlayerAverageStatisticsDataSource(_databaseFixture.ConnectionFactory, _queryBuilder.Object, _playerDataSource.Object);

            var results = await dataSource.ReadBestEconomyRate(null).ConfigureAwait(false);
        ...
        [Fact]
        public async Task Read_best_bowling_economy_supports_filter_by_club_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_best_bowling_economy_supports_filter_by_team_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_best_bowling_economy_supports_filter_by_team_route()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_best_bowling_economy_supports_filter_by_competition_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_best_bowling_economy_supports_filter_by_season_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_best_bowling_economy_sorts_by_lowest_economy_first()
        {
            var filter = new StatisticsFilter { Paging = new Paging { PageSize = int.MaxValue } };
            _queryBuilder.Setup(x => x.BuildWhereClause(It.IsAny<StatisticsFilter>())).Returns((string.Empty, new Dictionary<string, object>()));
            _playerDataSource.Setup(x => x.ReadPlayers(It.IsAny<PlayerFilter>())).Returns(Task.FromResult(_databaseFixture.TestData.Players));
            ...
            decimal? previousEconomy = decimal.MinValue;
            foreach (var result in results)
            {
                Assert.True(result.Result?.Average >= previousEconomy);
                previousEconomy = result.Result?.Average;
            }
        }

        [Fact]
        public async Task Read_best_bowling_economy_pages_results()
        {
