...
namespace Stoolball.Data.SqlServer.IntegrationTests.Statistics
{
    ...
    public class ReadBestPlayerBowlingStrikeRateTests
    {
        ...
        public ReadBestPlayerBowlingStrikeRateTests(SqlServerTestDataFixture databaseFixture)
        {
            _databaseFixture = databaseFixture ?? throw new ArgumentNullException(nameof(databaseFixture));
        }

        [Fact]
        public async Task Read_total_players_with_bowling_strike_rate_supports_no_filter()
        {
            ...
            var result = await dataSource.ReadTotalPlayersWithBowlingStrikeRate(null).ConfigureAwait(false);
        ...
        [Fact]
        public async Task Read_total_players_with_bowling_strike_rate_supports_filter_by_team_id()
        {
        ...
        [Fact]
        public async Task Read_total_players_with_bowling_strike_rate_supports_filter_by_team_route()
        {
            var filter = new StatisticsFilter { Team = _databaseFixture.TestData.TeamWithFullDetails };
        ...
        [Fact]
        public async Task Read_total_players_with_bowling_strike_rate_supports_filter_by_match_location_id()
        {
        ...
        [Fact]
        public async Task Read_total_players_with_bowling_strike_rate_supports_filter_by_competition_id()
        {
        ...
        [Fact]
        public async Task Read_best_bowling_strike_rate_returns_teams()
        {
            var filter = new StatisticsFilter { Paging = new Paging { PageSize = int.MaxValue } };
            _queryBuilder.Setup(x => x.BuildWhereClause(It.IsAny<StatisticsFilter>())).Returns((string.Empty, new Dictionary<string, object>()));
            _playerDataSource.Setup(x => x.ReadPlayers(It.IsAny<PlayerFilter>())).Returns(Task.FromResult(_databaseFixture.TestData.Players));
        ...
        [Fact]
        public async Task Read_best_bowling_strike_rate_supports_statistics_filtered_by_club_id()
        {
        ...
        [Fact]
        public async Task Read_best_bowling_strike_rate_supports_statistics_filtered_by_team_route()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_best_bowling_strike_rate_supports_statistics_filtered_by_match_location_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_best_bowling_strike_rate_supports_statistics_filtered_by_competition_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_best_bowling_strike_rate_supports_no_filter()
        {
            _queryBuilder.Setup(x => x.BuildWhereClause(It.IsAny<StatisticsFilter>())).Returns((string.Empty, new Dictionary<string, object>()));
            _playerDataSource.Setup(x => x.ReadPlayers(It.IsAny<PlayerFilter>())).Returns(Task.FromResult(_databaseFixture.TestData.Players));
            var dataSource = new SqlServerBestPlayerAverageStatisticsDataSource(_databaseFixture.ConnectionFactory, _queryBuilder.Object, _playerDataSource.Object);

            var results = await dataSource.ReadBestBowlingStrikeRate(null).ConfigureAwait(false);
        ...
        [Fact]
        public async Task Read_best_bowling_strike_rate_supports_filter_by_club_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_best_bowling_strike_rate_supports_filter_by_team_route()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_best_bowling_strike_rate_supports_filter_by_match_location_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
            ...
            var results = await dataSource.ReadBestBowlingStrikeRate(It.IsAny<StatisticsFilter>()).ConfigureAwait(false);
        ...
        [Fact]
        public async Task Read_best_bowling_strike_rate_supports_filter_by_competition_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
        ...
        [Fact]
        public async Task Read_best_bowling_strike_rate_supports_filter_by_season_id()
        {
            var filter = new StatisticsFilter
            {
                Paging = new Paging
