    ...
    public partial class DeleteObsoletePlayers : MigrationBase
    {
        ...
        protected override void Migrate()
        {
            ...
            if (!ColumnExists(Tables.PlayerIdentity, "Deleted"))
            {
                ...
                Execute.SqlFromFile("043_Delete_Obsolete_Players.Rename_ForAsyncDelete_Column.sql").Do();
                Execute.SqlFromFile("043_Delete_Obsolete_Players.vw_Stoolball_PlayerIdentity.sql").Do();
