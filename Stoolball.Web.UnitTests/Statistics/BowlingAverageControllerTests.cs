...
namespace Stoolball.Web.Tests.Statistics
{
    ...
    {
        internal static readonly Uri _requestUrl = new Uri("https://example.org" + Constants.Pages.StatisticsUrl + "/bowling-average?querystring=example");
        ...
        private class TestController : BowlingAverageController
        {
           ...
           : base(
            ...
            {
                return View("BowlingAverage", model);
            }
        }
        ...
        public async Task No_results_returns_StatisticsViewModel()
        {
            ...
            statisticsDataSource.Setup(x => x.ReadBestBowlingAverage(appliedFilter)).Returns(Task.FromResult(results as IEnumerable<StatisticsResult<BestStatistic>>));
