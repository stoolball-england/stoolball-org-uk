...
{
    public class PlayerPerformancesControllerTests : UmbracoBaseTest
    {
        ...
        public PlayerPerformancesControllerTests() : base()
        {
        }

        private PlayerPerformancesController CreateController()
        {
            return new PlayerPerformancesController(
                Mock.Of<ILogger<PlayerPerformancesController>>(),
