...
namespace Stoolball.Web.Tests.Clubs
{
    public class ClubStatisticsControllerTests : UmbracoBaseTest
    {
        ...
        public async Task Route_not_matching_club_returns_404()
        {
            ...
            using (var controller = new TestController(clubDataSource.Object, statisticsDataSource.Object, inningsDataSource.Object, statisticsFilterQueryStringParser.Object, UmbracoHelper))
            {
