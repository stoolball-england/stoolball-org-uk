...
namespace Stoolball.Web.UnitTests.Routing
{
    public class StoolballRouteParserTests
    {
        ...
        [InlineData("https://example.org/teams/example123/statistics/player-of-match", StoolballRouteType.PlayerOfTheMatch)]
        ...
        [InlineData("https://example.org/locations/example123/statistics/player-of-match", StoolballRouteType.PlayerOfTheMatch)]
        ...
        [InlineData("https://example.org/clubs/example123/statistics/player-of-match", StoolballRouteType.PlayerOfTheMatch)]
        ...
        [InlineData("https://example.org/competitions/example/statistics/player-of-match", StoolballRouteType.PlayerOfTheMatch)]
        ...
        [InlineData("https://example.org/competitions/example/2020/statistics/player-of-match", StoolballRouteType.PlayerOfTheMatch)]
        ...
        [InlineData("https://example.org/competitions/example/2020-21/statistics/player-of-match", StoolballRouteType.PlayerOfTheMatch)]
        ...
        [InlineData("https://example.org/play/statistics/player-of-match", StoolballRouteType.PlayerOfTheMatch)]
        ...
        [InlineData("https://example.org/players/example-name/player-of-match", StoolballRouteType.PlayerOfTheMatch)]
