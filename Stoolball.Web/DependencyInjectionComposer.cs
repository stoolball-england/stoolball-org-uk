...
namespace Stoolball.Web
{
    public class DependencyInjectionComposer : IUserComposer
    {
        public void Compose(Composition composition)
        {
            ...
            composition.Register<IUmbracoFormsDataMigrator, UmbracoFormsDataMigrator>(Lifetime.Singleton);
            ...
            composition.Register<SeasonResultsTableController>(Lifetime.Request);
            ...
            composition.Register<EditSeasonResultsTableController>(Lifetime.Request);
