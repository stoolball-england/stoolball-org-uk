...
{
    public class EmailAddressController : RenderController
    {
        ...
        {
            var model = new EmailAddress(CurrentPage, new PublishedValueFallback(_serviceContext, _variationContextAccessor));
