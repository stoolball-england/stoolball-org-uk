    ...
    public class StoolballRouteParser : IStoolballRouteParser
    {
        ...
        public StoolballRouteType? ParseRouteType(string route)
        {
            ...
            var routeTypes = new Dictionary<string, StoolballRouteType>
            {
                ...
                { $"players{SLASH}{ANY_VALID_ROUTE}{SLASH}player-performances{OPTIONAL_SLASH}", StoolballRouteType.PlayerPerformances },
                { $"players{SLASH}{ANY_VALID_ROUTE}{SLASH}player-of-match{OPTIONAL_SLASH}", StoolballRouteType.PlayerOfTheMatchAwards},
                ...
                { $"players{SLASH}{ANY_VALID_ROUTE}{SLASH}add-to-my-statistics{OPTIONAL_SLASH}", StoolballRouteType.LinkPlayerToMember },
                ...
                { $"competitions{SLASH}{ANY_VALID_ROUTE}{SLASH}{SEASON}{SLASH}statistics{SLASH}most-scores-of-[0-9]{{1,3}}{OPTIONAL_SLASH}", StoolballRouteType.MostScoresOfX },
                ...
                { $"competitions{SLASH}{ANY_VALID_ROUTE}{SLASH}{SEASON}{SLASH}statistics{SLASH}most-[0-9]{{1,2}}-wickets{OPTIONAL_SLASH}", StoolballRouteType.MostXWickets },
                ...
                { $"competitions{SLASH}{ANY_VALID_ROUTE}{SLASH}{SEASON}{SLASH}statistics{SLASH}player-performances{OPTIONAL_SLASH}", StoolballRouteType.PlayerPerformances },
                { $"competitions{SLASH}{ANY_VALID_ROUTE}{SLASH}{SEASON}{SLASH}statistics{SLASH}player-of-match{OPTIONAL_SLASH}", StoolballRouteType.PlayerOfTheMatchAwards },
                { $"competitions{SLASH}{ANY_VALID_ROUTE}{SLASH}{SEASON}{SLASH}statistics{SLASH}most-player-of-match{OPTIONAL_SLASH}", StoolballRouteType.MostPlayerOfTheMatchAwards },
                ...
                { $"clubs{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}most-scores-of-[0-9]{{1,3}}{OPTIONAL_SLASH}", StoolballRouteType.MostScoresOfX},
                ...
                { $"clubs{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}most-[0-9]{{1,2}}-wickets{OPTIONAL_SLASH}", StoolballRouteType.MostXWickets},
                ...
                { $"clubs{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}player-performances{OPTIONAL_SLASH}", StoolballRouteType.PlayerPerformances},
                { $"clubs{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}player-of-match{OPTIONAL_SLASH}", StoolballRouteType.PlayerOfTheMatchAwards },
                { $"clubs{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}most-player-of-match{OPTIONAL_SLASH}", StoolballRouteType.MostPlayerOfTheMatchAwards },
                ...
                { $"teams{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}most-scores-of-[0-9]{{1,3}}{OPTIONAL_SLASH}", StoolballRouteType.MostScoresOfX},
                ...
                { $"teams{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}most-[0-9]{{1,2}}-wickets{OPTIONAL_SLASH}", StoolballRouteType.MostXWickets},
                ...
                { $"teams{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}player-performances{OPTIONAL_SLASH}", StoolballRouteType.PlayerPerformances},
                { $"teams{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}player-of-match{OPTIONAL_SLASH}", StoolballRouteType.PlayerOfTheMatchAwards },
                { $"teams{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}most-player-of-match{OPTIONAL_SLASH}", StoolballRouteType.MostPlayerOfTheMatchAwards },
                ...
                { $"locations{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}most-scores-of-[0-9]{{1,3}}{OPTIONAL_SLASH}", StoolballRouteType.MostScoresOfX },
                ...
                { $"locations{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}most-[0-9]{{1,2}}-wickets{OPTIONAL_SLASH}", StoolballRouteType.MostXWickets },
                ...
                { $"locations{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}player-performances{OPTIONAL_SLASH}", StoolballRouteType.PlayerPerformances },
                { $"locations{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}player-of-match{OPTIONAL_SLASH}", StoolballRouteType.PlayerOfTheMatchAwards },
                { $"locations{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}most-player-of-match{OPTIONAL_SLASH}", StoolballRouteType.MostPlayerOfTheMatchAwards },
                ...
                { $"competitions{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}most-scores-of-[0-9]{{1,3}}{OPTIONAL_SLASH}", StoolballRouteType.MostScoresOfX },
                ...
                { $"competitions{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}most-[0-9]{{1,2}}-wickets{OPTIONAL_SLASH}", StoolballRouteType.MostXWickets },
                ...
                { $"competitions{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}player-performances{OPTIONAL_SLASH}", StoolballRouteType.PlayerPerformances },
                { $"competitions{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}player-of-match{OPTIONAL_SLASH}", StoolballRouteType.PlayerOfTheMatchAwards },
                { $"competitions{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}most-player-of-match{OPTIONAL_SLASH}", StoolballRouteType.MostPlayerOfTheMatchAwards },
                ...
                { $"matches{SLASH}{ANY_VALID_ROUTE}{SLASH}edit{SLASH}format{OPTIONAL_SLASH}", StoolballRouteType.EditMatchFormat },
                ...
                { $"play{SLASH}statistics{SLASH}most-scores-of-[0-9]{{1,3}}{OPTIONAL_SLASH}", StoolballRouteType.MostScoresOfX },
                { $"play{SLASH}statistics{SLASH}bowling-figures{OPTIONAL_SLASH}", StoolballRouteType.BowlingFigures },
                { $"play{SLASH}statistics{SLASH}player-performances{OPTIONAL_SLASH}", StoolballRouteType.PlayerPerformances },
                { $"play{SLASH}statistics{SLASH}player-of-match{OPTIONAL_SLASH}", StoolballRouteType.PlayerOfTheMatchAwards },
                { $"play{SLASH}statistics{SLASH}most-player-of-match{OPTIONAL_SLASH}", StoolballRouteType.MostPlayerOfTheMatchAwards },
                ...
                { $"play{SLASH}statistics{SLASH}most-[0-9]{{1,2}}-wickets{OPTIONAL_SLASH}", StoolballRouteType.MostXWickets },
                ...
                // Match /account/my-statistics
                { $"account{SLASH}my-statistics{OPTIONAL_SLASH}", StoolballRouteType.LinkedPlayersForMember }
            };
