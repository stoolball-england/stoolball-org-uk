    ...
    public class StoolballRouteParser : IStoolballRouteParser
    {
        ...
        public StoolballRouteType? ParseRouteType(string route)
        {
            ...
            var routeTypes = new Dictionary<string, StoolballRouteType>
            {
                ...
                { $"players{SLASH}{ANY_VALID_ROUTE}{SLASH}player-of-match{OPTIONAL_SLASH}", StoolballRouteType.PlayerOfTheMatch},
                ...
                { $"competitions{SLASH}{ANY_VALID_ROUTE}{SLASH}{SEASON}{SLASH}statistics{SLASH}player-of-match{OPTIONAL_SLASH}", StoolballRouteType.PlayerOfTheMatch },
                ...
                { $"clubs{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}player-of-match{OPTIONAL_SLASH}", StoolballRouteType.PlayerOfTheMatch },
                ...
                { $"teams{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}player-of-match{OPTIONAL_SLASH}", StoolballRouteType.PlayerOfTheMatch },
                ...
                { $"locations{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}player-of-match{OPTIONAL_SLASH}", StoolballRouteType.PlayerOfTheMatch },
                ...
                { $"competitions{SLASH}{ANY_VALID_ROUTE}{SLASH}statistics{SLASH}player-of-match{OPTIONAL_SLASH}", StoolballRouteType.PlayerOfTheMatch },
                ...
                { $"play{SLASH}statistics{SLASH}player-of-match{OPTIONAL_SLASH}", StoolballRouteType.PlayerOfTheMatch },
