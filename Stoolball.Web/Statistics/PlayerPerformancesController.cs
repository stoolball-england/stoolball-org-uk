...
{
    public class PlayerPerformancesController : RenderController, IRenderControllerAsync
    {
        ...
        public async new Task<IActionResult> Index()
        {
            ...
            model.FilterDescription = _statisticsFilterHumanizer.EntitiesMatchingFilter("Player performances", _statisticsFilterHumanizer.MatchingUserFilter(model.AppliedFilter));
            model.Metadata.PageTitle = "Player performances" + _statisticsFilterHumanizer.MatchingFixedFilter(model.AppliedFilter) + _statisticsFilterHumanizer.MatchingUserFilter(model.AppliedFilter);
