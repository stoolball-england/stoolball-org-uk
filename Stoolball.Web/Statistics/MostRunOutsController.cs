...
{
    public class MostRunOutsController : RenderController, IRenderControllerAsync
    {
        ...
        public MostRunOutsController(ILogger<MostRunOutsController> logger,
        ...
        public async new Task<IActionResult> Index()
        {
            ...
            model.Results = (await _statisticsDataSource.ReadMostRunOuts(model.AppliedFilter)).ToList();

            model.AppliedFilter.Paging.PageUrl = new Uri(Request.GetEncodedUrl());
            model.AppliedFilter.Paging.Total = await _statisticsDataSource.ReadTotalPlayersWithRunOuts(model.AppliedFilter);
            ...
            model.Metadata.PageTitle = "Most run-outs" + _statisticsFilterHumanizer.MatchingFixedFilter(model.AppliedFilter) + _statisticsFilterHumanizer.MatchingUserFilter(model.AppliedFilter);
