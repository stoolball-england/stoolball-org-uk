...
{
    public class BattingStrikeRateController : RenderController, IRenderControllerAsync
    {
        ...
        public async new Task<IActionResult> Index()
        {
            ...
            model.Results = (await _statisticsDataSource.ReadBestBattingStrikeRate(model.AppliedFilter)).ToList();

            model.AppliedFilter.Paging.PageUrl = new Uri(Request.GetEncodedUrl());
            model.AppliedFilter.Paging.Total = await _statisticsDataSource.ReadTotalPlayersWithBattingStrikeRate(model.AppliedFilter);
