...
{
    public class BattingAverageController : RenderController, IRenderControllerAsync
    {
        ...
        public async new Task<IActionResult> Index()
        {
            ...
            model.Results = (await _statisticsDataSource.ReadBestBattingAverage(model.AppliedFilter)).ToList();

            model.AppliedFilter.Paging.PageUrl = new Uri(Request.GetEncodedUrl());
            model.AppliedFilter.Paging.Total = await _statisticsDataSource.ReadTotalPlayersWithBattingAverage(model.AppliedFilter);
