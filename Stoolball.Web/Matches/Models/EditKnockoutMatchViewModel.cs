...
{
    public class EditKnockoutMatchViewModel : BaseViewModel, IEditMatchViewModel
    {
        public EditKnockoutMatchViewModel(IPublishedContent? contentModel = null, IUserService? userService = null) : base(contentModel, userService)
        {
        }
