...
{
    public class EditKnockoutMatchController : RenderController, IRenderControllerAsync
    {
        ...
        public EditKnockoutMatchController(ILogger<EditKnockoutMatchController> logger,
