...
namespace Stoolball.Web.Competitions
{
    public class EditSeasonSurfaceController : SurfaceController
    {
        ...
        public async Task<ActionResult> UpdateSeason([Bind(Prefix = "Season", Include = "EnableTournaments,PlayersPerTeam,Overs,EnableLastPlayerBatsOn,ResultsTableType,EnableRunsScored,EnableRunsConceded")] Season season)
        {
            if (season is null)
            {
