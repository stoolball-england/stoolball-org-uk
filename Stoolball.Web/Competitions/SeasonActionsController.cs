...
{
    public class SeasonActionsController : RenderController, IRenderControllerAsync
    {
        private readonly ISeasonDataSource _seasonDataSource;
        private readonly IAuthorizationPolicy<Competition> _authorizationPolicy;

        public SeasonActionsController(ILogger<SeasonActionsController> logger,
        ...
        public async new Task<IActionResult> Index()
        {
            ...
            {
                Season = await _seasonDataSource.ReadSeasonByRoute(Request.Path).ConfigureAwait(false)
            };
