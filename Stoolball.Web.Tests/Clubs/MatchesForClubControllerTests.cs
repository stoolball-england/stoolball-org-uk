...
namespace Stoolball.Web.Tests.Clubs
{
    public class MatchesForClubControllerTests : UmbracoBaseTest
    {
        ...
        {
            public TestController(IClubDataSource clubDataSource, IMatchDataSource matchDataSource)
           : base(
                ...
                null, clubDataSource, matchDataSource, Mock.Of<IDateFormatter>(), Mock.Of<IEstimatedSeason>())
            {
