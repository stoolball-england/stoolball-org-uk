    ...
    public class TransientTeamControllerTests : UmbracoBaseTest
    {
        private class TestController : TransientTeamController
        {
           ...
           : base(
                ...
                null, teamDataSource, matchDataSource, Mock.Of<IDateFormatter>(), Mock.Of<IEmailProtector>())
            {
        ...
        public async Task Route_matching_team_returns_TeamViewModel()
        {
            ...
            teamDataSource.Setup(x => x.ReadTeamByRoute(It.IsAny<string>(), true)).ReturnsAsync(new Team { TeamId = 1 });
