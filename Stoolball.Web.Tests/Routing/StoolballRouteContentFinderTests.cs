...
namespace Stoolball.Web.Tests.Routing
{
    public class StoolballRouteContentFinderTests
    {
        ...
        [InlineData("https://example.org/competitions/example/2020-21/mAtChEs/", StoolballRouteType.MatchesForSeason)]
        [InlineData("https://example.org/competitions/example/2020/results", StoolballRouteType.SeasonResults)]
        [InlineData("https://example.org/competitions/example/2020/Results/", StoolballRouteType.SeasonResults)]
        [InlineData("https://example.org/competitions/example/2020-21/results", StoolballRouteType.SeasonResults)]
        [InlineData("https://example.org/competitions/EXAMPLE/2020-21/Results/", StoolballRouteType.SeasonResults)]
        ...
        [InlineData("https://example.org/competitions/EXAMPLE/2020-21/EDIT/Season/", StoolballRouteType.EditSeason)]
        [InlineData("https://example.org/competitions/example/2020/edit/results", StoolballRouteType.EditSeasonResults)]
        [InlineData("https://example.org/competitions/EXAMPLE/2020/EDIT/results/", StoolballRouteType.EditSeasonResults)]
        [InlineData("https://example.org/competitions/example/2020-21/edit/results", StoolballRouteType.EditSeasonResults)]
        [InlineData("https://example.org/competitions/EXAMPLE/2020-21/EDIT/REsults/", StoolballRouteType.EditSeasonResults)]
