...
namespace Stoolball.Web.Tests.Routing
{
    public class StoolballRouteContentFinderTests
    {
        ...
        [InlineData("https://example.org/competitions/EXAMPLE/2020-21/EDIT/Season/", StoolballRouteType.EditSeason)]
        [InlineData("https://example.org/competitions/example/2020/edit/points", StoolballRouteType.EditSeasonPoints)]
        [InlineData("https://example.org/competitions/EXAMPLE/2020/EDIT/points/", StoolballRouteType.EditSeasonPoints)]
        [InlineData("https://example.org/competitions/example/2020-21/edit/points", StoolballRouteType.EditSeasonPoints)]
        [InlineData("https://example.org/competitions/EXAMPLE/2020-21/EDIT/Points/", StoolballRouteType.EditSeasonPoints)]
