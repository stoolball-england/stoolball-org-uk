...
robocopy .\Stoolball.Web .\.UmbracoCloud /IF *.dll *.cshtml *.uda /XF Umbraco.*.dll /S /XD .git $projectRoot\Stoolball.Web\obj $projectRoot\Stoolball.Web\umbraco $projectRoot\Stoolball.Web\App_Data $projectRoot\Stoolball.Web\App_Plugins\Deploy $projectRoot\Stoolball.Web\App_Plugins\UmbracoForms $projectRoot\Stoolball.Web\Content $projectRoot\Stoolball.Web\Scripts $projectRoot\Stoolball.Web\Media
