...
namespace Stoolball.Tests.Competitions
{
    public class SeasonTests
    {
        ...
        public void Season_name_is_built_correctly(int startYear, int endYear, string expectedName)
        {
            var season = new Season { StartYear = startYear, EndYear = endYear };
        ...
        public void Season_full_name_and_player_type_is_built_correctly(string competitionName, int startYear, int endYear, PlayerType playerType, string expectedName)
        {
